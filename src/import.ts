...
/* 
what do we want our end schema to look like?


username: string

blocked: boolean
blocked_timestamp: number

close_friends: boolean
close_friends_timestamp: number

requested_to_follow: boolean
requested_to_follow_timestamp: number

follower: boolean
follower_timestamp: number

following: boolean
following_timestamp: number

hidden_story_from: boolean
hidden_story_from_timestamp: number

requested_to_follow: boolean
requested_to_follow_timestamp: number

recently_unfollowed: boolean
recently_unfollowed_timestamp: number
*/
