...
const Layout: ParentComponent = (props) => {
	...
	return (
		<div class="flex min-h-screen flex-col bg-gray-950">
			...
			{isDemoMode() && (
				<div class="border-b border-purple/60 bg-purple/10">
					<div class="container mx-auto flex items-center justify-between gap-4 px-4 py-2 text-sm">
						...
						<button
							type="button"
							class="rounded-md border border-purple px-3 py-1.5 font-medium text-gray-100 transition-colors hover:bg-purple/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink disabled:cursor-not-allowed disabled:opacity-50"
			...
			<footer class="border-t border-gray-700 bg-gray-950 py-6">
				<div class="container mx-auto px-4">
					<div class="flex flex-col items-center justify-between text-sm text-gray-500 md:flex-row">
						...
						<div>
							<a
								...
								class="flex items-center gap-1 font-medium text-gray-400 transition-colors hover:text-gray-100"
							>
